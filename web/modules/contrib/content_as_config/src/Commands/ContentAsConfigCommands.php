...
class ContentAsConfigCommands extends DrushCommands {
   ...
   *   'taxonomy_term', 'group', or 'feeds_feed'.
   *
   ...
   */
  public function import(string $entity_type, array $options = ['style' => 'safe']): void {
    $controller = $this->getController($entity_type);
   ...
   */
  public function importAll(array $options = ['style' => 'safe']): void {
    foreach (array_keys($this->controllerInfo) as $entity_type) {
